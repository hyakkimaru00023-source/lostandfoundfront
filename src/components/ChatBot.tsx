...
export default function ChatBot({ onSuggestionApply, onInfoExtracted, className }: ChatBotProps) {
  ...
  const handleSend = async (messageText?: string) => {
    ...
    try {
      ...
      // Handle extracted info for auto-fill
      if (response.extracted_info && onInfoExtracted) {
        onInfoExtracted(response.extracted_info);
      }
    } catch (error) {
